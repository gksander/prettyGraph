...
var app = new Vue({
    ...
    data: {
        ...
        elementTypes: [['none', 'Choose one...'], ['functiongraph', 'Function Graph'], ['curve', 'Curve'], ['text', 'Text'], ['point', 'Point'], ['line', 'Line'], ['circle', 'Circle'], ['polygon', 'Polygon']],
    ...
    methods: {
        ...
        constructionDefaults: function constructionDefaults(c) {
            return {
        ...
        buildBoardElement: function buildBoardElement(ops) {
            var _this = this;
            ...
            try {
                switch (ops.type) {
                    case "functiongraph":
                        ...
                        this.tmp[id] = this.board.create('functiongraph', [function (x) {
                            var s = _this.getMathScope();
                            s['x'] = x;
                            try {
                    ...
                    // CURVES
                    case "curve":
                        this.tmp[id] = this.board.create("curve", [function (t) {
                    ...
                    case "text":
                        ...
                        if (ops.loc.indexOf("n") == -1 && ops.loc.indexOf("x") == -1) {
                            ...
                            this.tmp[id] = this.board.create('text', [math.eval(loc[0]), math.eval(loc[1]), textF], ats);
                            ...
                            this.tmp[id] = this.board.create('text', [function () {
                                try {
                    ...
                    case "point":
                        ...
                        this.tmp[ops.id] = this.board.create('point', [function () {
                            try {
                                return math.eval(loc[0], that.getMathScope());
                            } catch (err) {
                                return 0;
                    ...
                    case "line":
                        ...
                        //
                        this.tmp[id] = this.board.create('line', [function () {
                            try {
                    ...
                    case "circle":
                        ...
                        this.tmp[id] = this.board.create('circle', [[function () {
                            try {
                                return math.eval(s[0], that.getMathScope());
                            } catch (err) {
                                return 0;
                            }
                        }, function () {
                            try {
                                return math.eval(s[1], that.getMathScope());
                            } catch (err) {
                                return 0;
                            }
                        }], function () {
                            try {
                                return math.eval(ops.r, that.getMathScope());
                            } catch (err) {
                                return 1;
                            }
                        }], {
                    ...
                    case "polygon":
                        ...
                        for (var i = 0; i < ops.loc.length; i++) {
                            _loop(i);
                        };
        ...
        // Run declarations
        runDeclarations: function runDeclarations(val) {
            this.parser.clear();
        ...
        // String to Display
        stringToDisplay: function stringToDisplay(text) {
            var o = text,
                that = this;
        ...
        renderBoardMath: function renderBoardMath() {
        ...
        // Get math scope
        getMathScope: function getMathScope() {
        ...
        pointToArray: function pointToArray(point) {
            var o = point.trim();
            o = o.substr(1);
